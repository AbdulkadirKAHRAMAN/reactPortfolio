  ...
  return (
    ...
    >
      <div style={{ maxWidth: '800px', margin: '0 auto', textAlign: 'center' }}>
        <h2>Contact Me!</h2>
        <p>Contact me to talk about your projects and co-operate!</p>
        ...
        <form
          action="https://getform.io/f/apjnxnma"
          method="POST"
          style={{ marginTop: '30px', display: 'flex', flexDirection: 'column', gap: '10px' }}
        >
          <input
            type="text"
            name="name"
          ...
          <textarea
            ...
            required
            style={{ padding: '10px', borderRadius: '5px', border: 'none', minHeight: '100px' }}
          ></textarea>
          <button
            type="submit"
            style={{ padding: '10px', borderRadius: '5px', border: 'none', backgroundColor: '#fff', color: '#000', cursor: 'pointer' }}
          >
            Submit
          </button>
        </form>
